...
func setSetGo() (*asset, error) {
	...
	info := bindataFileInfo{name: "set/set.go", size: 5597, mode: os.FileMode(420), modTime: time.Unix(1587184979, 0)}
...
func stackStackGo() (*asset, error) {
	...
	info := bindataFileInfo{name: "stack/stack.go", size: 1017, mode: os.FileMode(420), modTime: time.Unix(1587274960, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
